...
namespace Avalonia.MusicStore.ViewModels
{
    public class MusicStoreViewModel : ViewModelBase
    {
        ...
        public string? SearchText
        {
            ...
            // -> everytime the SearchText property is updated since it is called in the setter method.
        ...
        public MusicStoreViewModel()
        {
            ...
            this.WhenAnyValue(x => x.SearchText)
                .Throttle(TimeSpan
                    .FromMilliseconds(
                        400)) // to not query on every key stroke.. query the results if the user stopped typing for 400ms
